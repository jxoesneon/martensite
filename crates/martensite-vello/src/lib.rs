...
//
// This is a vendored copy of `netrender-vello` 0.10.0 — a byte-compatible
// republish of upstream Vello built against wgpu 30. Upstream code style is
// preserved.
//
// This crate inherits workspace lints but overrides the following rules
// because it is vendored upstream code we do not own:
...
//   attributes hit the false positive tracked as rust issue #129255.
#![allow(unsafe_code)]
#![allow(missing_docs)]
#![allow(clippy::all)]
#![allow(clippy::todo)]

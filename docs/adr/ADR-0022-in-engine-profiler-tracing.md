# [ADR-0022] In-Engine Profiler and Tracing

* **Status:** Accepted
* **Date:** 2026-09-06
* **Deciders:** Master (Sovereign Architect), Ciel (Systems Architecture Guild)
* **Technical Domain:** `in-engine-profiler-tracing`

## Context and Problem Statement

For a sovereign, retained-mode, GPU-accelerated GUI engine targeting v1.0.0, handling in-engine-profiler-tracing is a critical requirement. We must establish a robust, performant, and safe architecture.
...
* **Option 3**: **Integrate tracing-subscriber with an in-app overlay for real-time performance metrics**.

## Decision Outcome

Chosen option: **Option 3**. Integrate tracing-subscriber with an in-app overlay for real-time performance metrics perfectly aligns with the Anti-Slop Doctrine, providing explicit, measurable, and high-performance guarantees.

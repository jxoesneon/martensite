...
For a retained-mode, GPU-accelerated GUI framework targeting v1.0.0, handling in-engine-profiler-tracing is a critical requirement. We must establish a robust, performant, and safe architecture.
...
Chosen option: **Option 3**. Integrate tracing-subscriber with an in-app overlay for real-time performance metrics perfectly provides reliable performance guarantees, providing explicit, measurable, and high-performance guarantees.

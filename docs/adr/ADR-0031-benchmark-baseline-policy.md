...
For a retained-mode, GPU-accelerated GUI framework targeting v1.0.0, handling benchmark-baseline-policy is a critical requirement. We must establish a robust, performant, and safe architecture.
...
Chosen option: **Option 3**. Mandate Criterion benchmarks for layout/render paths; CI fails on >5% regression perfectly provides reliable performance guarantees, providing explicit, measurable, and high-performance guarantees.

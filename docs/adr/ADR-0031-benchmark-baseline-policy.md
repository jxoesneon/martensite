# [ADR-0031] Benchmark Baseline Policy

* **Status:** Accepted
* **Date:** 2026-09-06
* **Deciders:** Master (Sovereign Architect), Ciel (Systems Architecture Guild)
* **Technical Domain:** `benchmark-baseline-policy`

## Context and Problem Statement

For a sovereign, retained-mode, GPU-accelerated GUI engine targeting v1.0.0, handling benchmark-baseline-policy is a critical requirement. We must establish a robust, performant, and safe architecture.
...
* **Option 3**: **Mandate Criterion benchmarks for layout/render paths; CI fails on >5% regression**.

## Decision Outcome

Chosen option: **Option 3**. Mandate Criterion benchmarks for layout/render paths; CI fails on >5% regression perfectly aligns with the Anti-Slop Doctrine, providing explicit, measurable, and high-performance guarantees.

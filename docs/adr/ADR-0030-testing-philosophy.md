# [ADR-0030] Testing Philosophy (Unit, Integration, Golden)

* **Status:** Accepted
* **Date:** 2026-09-06
* **Deciders:** Master (Sovereign Architect), Ciel (Systems Architecture Guild)
* **Technical Domain:** `testing-philosophy`

## Context and Problem Statement

For a sovereign, retained-mode, GPU-accelerated GUI engine targeting v1.0.0, handling testing-philosophy is a critical requirement. We must establish a robust, performant, and safe architecture.
...
* **Option 3**: **Enforce logic unit tests, integration trait tests, and pixel-perfect golden frame tests**.

## Decision Outcome

Chosen option: **Option 3**. Enforce logic unit tests, integration trait tests, and pixel-perfect golden frame tests perfectly aligns with the Anti-Slop Doctrine, providing explicit, measurable, and high-performance guarantees.

...
For a retained-mode, GPU-accelerated GUI framework targeting v1.0.0, handling undo-redo-transactions is a critical requirement. We must establish a robust, performant, and safe architecture.
...
Chosen option: **Option 3**. Adopt a command pattern with immutable persistent data structures for deterministic undo/redo perfectly provides reliable performance guarantees, providing explicit, measurable, and high-performance guarantees.

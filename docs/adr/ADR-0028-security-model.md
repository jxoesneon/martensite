# [ADR-0028] Security Model and Supply Chain

* **Status:** Accepted
* **Date:** 2026-09-06
* **Deciders:** Master (Sovereign Architect), Ciel (Systems Architecture Guild)
* **Technical Domain:** `security-model`

## Context and Problem Statement

For a sovereign, retained-mode, GPU-accelerated GUI engine targeting v1.0.0, handling security-model is a critical requirement. We must establish a robust, performant, and safe architecture.
...
* **Option 3**: **Mandate cargo-vet, forbid unsafe outside FFI boundaries, isolate asset parsing**.

## Decision Outcome

Chosen option: **Option 3**. Mandate cargo-vet, forbid unsafe outside FFI boundaries, isolate asset parsing perfectly aligns with the Anti-Slop Doctrine, providing explicit, measurable, and high-performance guarantees.

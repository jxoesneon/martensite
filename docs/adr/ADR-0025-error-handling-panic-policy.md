# [ADR-0025] Error Handling and Panic Policy

* **Status:** Accepted
* **Date:** 2026-09-06
* **Deciders:** Master (Sovereign Architect), Ciel (Systems Architecture Guild)
* **Technical Domain:** `error-handling-and-panic-policy`

## Context and Problem Statement

For a sovereign, retained-mode, GPU-accelerated GUI engine targeting v1.0.0, handling error-handling-and-panic-policy is a critical requirement. We must establish a robust, performant, and safe architecture.
...
* **Option 3**: **Ban unwrap/expect in library code; panic only on contract violations (e.g., NaN layout)**.

## Decision Outcome

Chosen option: **Option 3**. Ban unwrap/expect in library code; panic only on contract violations (e.g., NaN layout) perfectly aligns with the Anti-Slop Doctrine, providing explicit, measurable, and high-performance guarantees.

# [ADR-0014] Asset and Shader Virtual File System

* **Status:** Accepted
* **Date:** 2026-09-06
* **Deciders:** Master (Sovereign Architect), Ciel (Systems Architecture Guild)
* **Technical Domain:** `asset-and-shader-vfs`

## Context and Problem Statement

For a sovereign, retained-mode, GPU-accelerated GUI engine targeting v1.0.0, handling asset-and-shader-vfs is a critical requirement. We must establish a robust, performant, and safe architecture.
...
* **Option 3**: **Create a VFS layer for assets and shaders with hot-reloading in debug builds and embedded bytes in release builds**.

## Decision Outcome

Chosen option: **Option 3**. Create a VFS layer for assets and shaders with hot-reloading in debug builds and embedded bytes in release builds perfectly aligns with the Anti-Slop Doctrine, providing explicit, measurable, and high-performance guarantees.

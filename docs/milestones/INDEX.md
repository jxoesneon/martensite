...
| **v0.20.0** *(tentative)* | [v0.19.0-distribution.md](v0.19.0-distribution.md) | `cargo-martensite`, release workflows | WiX/DMG/Flatpak installers, Ed25519 signed updates, prebuilt CLI binaries (deferred per tentative-scope clause) | Installers built in CI on tag; signed-update manifest verified end-to-end |

...
- [audits/BLUETEAM_02_REACTIVE_DAG.md](audits/BLUETEAM_02_REACTIVE_DAG.md) — Epoch-based edge GC, glitch-free diamond BFS-pull batching, release depth circuit breakers

...
1. `cargo metadata` selects the publishable crates — workspace members
   under `crates/` without `publish = false` (46 crates). Excluded:
...
_46 publishable crates. Generated by `python3 scripts/api_surface_audit.py` from rustdoc JSON (stable + `RUSTC_BOOTSTRAP`); do not edit between the markers._

**Workspace total: 2895 public items, 2465 stable / 291 experimental / 139 vendored.**

| Crate | Items | Stable | Experimental | Vendored | Notes |
| :--- | ---: | ---: | ---: | ---: | :--- |
| `martensite` | 1236 | 1208 | 28 | 0 | crate-root aliases expose experimental sub-surface |
...
**1236 public items** — 1208 stable, 28 experimental. Categories: 3 constants, 71 enums, 3 functions, 278 modules, 524 re-exports, 354 structs, 1 traits, 2 type aliases.
...
| :--- | ---: | ---: | ---: | :--- |
| `(crate root)` | 24 | 23 | 1 | 4 modules, 20 re-exports |
...
### `martensite-access-platform` (v0.18.0)
...
### `martensite-accesskit-winit` (v0.18.0)
...
### `martensite-clipboard-platform` (v0.18.0)
...
### `martensite-dialog-platform` (v0.18.0)
...
### `martensite-engine-bridge` (v0.18.0)
...
### `martensite-font-fallback` (v0.18.0)
...
### `martensite-media-platform` (v0.18.0)
...
### `martensite-notify-platform` (v0.18.0)
...
### `martensite-pdf-platform` (v0.18.0)
...
### `martensite-print-platform` (v0.18.0)
...
### `martensite-share-platform` (v0.18.0)
...
### `martensite-webview-platform` (v0.18.0)

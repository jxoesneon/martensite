...
**Workspace total: 1605 public items, 1177 stable / 289 experimental / 139 vendored.**

| Crate | Items | Stable | Experimental | Vendored | Notes |
| :--- | ---: | ---: | ---: | ---: | :--- |
| `martensite` | 176 | 150 | 26 | 0 | crate-root aliases expose experimental sub-surface |
...
| `martensite-window` | 102 | 91 | 11 | 0 |  |

### `martensite` (v0.17.0)

**176 public items** — 150 stable, 26 experimental. Categories: 3 constants, 9 enums, 18 modules, 123 re-exports, 23 structs.
...
| :--- | ---: | ---: | ---: | :--- |
| `(crate root)` | 23 | 22 | 1 | 3 modules, 20 re-exports |
| `app` | 4 | 4 | 0 | 1 constants, 3 structs |
| `prelude` | 75 | 59 | 16 | 75 re-exports |
| `widgets` | 74 | 65 | 9 | 2 constants, 9 enums, 15 modules, 28 re-exports, 20 structs |
...
**102 public items** — 91 stable, 11 experimental. Categories: 1 constants, 10 enums, 15 functions, 10 modules, 44 re-exports, 22 structs.

...
**Workspace total: 1589 public items, 1240 stable / 349 experimental-or-vendored.**

| Crate | Items | Stable | Experimental | Notes |
| :--- | ---: | ---: | ---: | :--- |
| `martensite` | 162 | 157 | 5 |  |
| `martensite-access` | 104 | 104 | 0 |  |
| `martensite-access-platform` | 0 | 0 | 0 | crate-level experimental |
| `martensite-accesskit-winit` | 1 | 0 | 1 | vendored fork |
| `martensite-assets` | 33 | 31 | 2 |  |
| `martensite-blessed` | 58 | 24 | 34 |  |
| `martensite-clipboard` | 29 | 29 | 0 |  |
| `martensite-clipboard-platform` | 4 | 4 | 0 |  |
| `martensite-core` | 96 | 89 | 7 |  |
| `martensite-cosmic-text` | 89 | 0 | 89 | vendored fork |
| `martensite-devtools` | 25 | 18 | 7 |  |
| `martensite-dnd` | 49 | 49 | 0 |  |
| `martensite-engine-bridge` | 47 | 0 | 47 | crate-level experimental |
| `martensite-focus` | 22 | 22 | 0 |  |
| `martensite-font-fallback` | 3 | 3 | 0 |  |
| `martensite-history` | 17 | 17 | 0 |  |
| `martensite-host` | 4 | 0 | 4 | crate-level experimental |
| `martensite-l10n` | 11 | 11 | 0 |  |
| `martensite-layout` | 56 | 56 | 0 |  |
| `martensite-macros` | 1 | 1 | 0 |  |
| `martensite-media` | 88 | 65 | 23 |  |
| `martensite-media-platform` | 33 | 18 | 15 |  |
| `martensite-motion` | 27 | 27 | 0 |  |
| `martensite-plugin` | 31 | 14 | 17 |  |
| `martensite-reactive` | 71 | 58 | 13 |  |
| `martensite-render` | 38 | 38 | 0 |  |
| `martensite-shell` | 29 | 24 | 5 |  |
| `martensite-test` | 36 | 36 | 0 |  |
| `martensite-text` | 142 | 142 | 0 |  |
| `martensite-theme` | 45 | 45 | 0 |  |
| `martensite-vello` | 49 | 0 | 49 | vendored fork |
| `martensite-wgpu` | 87 | 65 | 22 |  |
| `martensite-window` | 102 | 93 | 9 |  |
